...
type OrderClient interface {
	...
	CreateCartItem(ctx context.Context, in *CartItemRequest, opts ...grpc.CallOption) (*ShopCartItemInfoResponse, error)
...
func (c *orderClient) CreateCartItem(ctx context.Context, in *CartItemRequest, opts ...grpc.CallOption) (*ShopCartItemInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ShopCartItemInfoResponse)
...
type OrderServer interface {
	...
	CreateCartItem(context.Context, *CartItemRequest) (*ShopCartItemInfoResponse, error)
...
func (UnimplementedOrderServer) CreateCartItem(context.Context, *CartItemRequest) (*ShopCartItemInfoResponse, error) {
